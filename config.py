...
class DirectoryConfig:
    ...
    log_directory: str = os.getenv("LOG_PATH", "log")
    results_directory: str = os.getenv("RESULTS_PATH", "results")
...
def create_app_config() -> AppConfig:
    ...
    return AppConfig(
        ollama=OllamaConfig(), image=ImageConfig(), directories=DirectoryConfig()
    )
